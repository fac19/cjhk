...
('Health','Downward Dog App','Select your time, level, focus, voice, and music, and Down Dog creates a unique, personalized yoga practice every time.','https://www.downdogapp.com/','yogafan',18),
('News','Worldometer','Worldometer is a reference website that provides counters and real-time statistics for diverse topics.','https://www.worldometers.info/coronavirus/','scaredofviruses',5),
('Work','Miro','A shareable whiteboard.','http://miro.com/','lovewhiteboards',13),
